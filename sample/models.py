...
class Brand(models.Model):
    COUNTRY_CHOICES = [
        ...
        ('Azerbaijan', 'Azerbaijan'), ('Bangladesh', 'Bangladesh'), ('Belgium', 'Belgium'),
        ...
        ('Kenya', 'Kenya'), ('South Korea', 'South Korea'), ('Kuwait', 'Kuwait'),
        ('Laos', 'Laos'), ('Lebanon', 'Lebanon'), ('Libya', 'Libya'),
        ...
        ('Oman', 'Oman'), ('Pakistan', 'Pakistan'), ('Peru', 'Peru'),
        ('Philippines', 'Philippines'), ('Poland', 'Poland'), ('Portugal', 'Portugal'),
        ('Qatar', 'Qatar'), ('Romania', 'Romania'), ('Russia', 'Russia'),
        ('Saudi Arabia', 'Saudi Arabia'), ('Senegal', 'Senegal'), ('Singapore', 'Singapore'),
        ...
        ('Turkey', 'Turkey'), ('Uganda', 'Uganda'), ('Ukraine', 'Ukraine'),
